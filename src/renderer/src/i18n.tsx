...
const en = {
  ...
  'memory.description':
    'Claude profiles discovered from .claude-* directories in your home folder.',
  'memory.add': 'Add custom memory preset',
  'memory.loading': 'Loading custom memory presets…',
  'memory.empty': 'No custom Claude memory directories found.',
  ...
  'memory.name': 'Name',
  'memory.nameHint': 'Creates ~/.claude-name and the alias claude-name.',
...
const sk: Record<MessageKey, string> = {
  ...
  'memory.description':
    'Claude profily nájdené podľa priečinkov .claude-* vo vašom domovskom priečinku.',
  'memory.add': 'Pridať vlastnú pamäť',
  'memory.loading': 'Načítavajú sa vlastné pamäte…',
  'memory.empty': 'Nenašli sa žiadne vlastné Claude pamäte.',
  ...
  'memory.name': 'Názov',
  'memory.nameHint': 'Vytvorí ~/.claude-nazov a alias claude-nazov.',
...
const cs: Record<MessageKey, string> = {
  ...
  'memory.description': 'Claude profily nalezené podle složek .claude-* v domovské složce.',
  'memory.add': 'Přidat vlastní paměť',
  'memory.loading': 'Načítání vlastních pamětí…',
  'memory.empty': 'Nebyly nalezeny žádné vlastní Claude paměti.',
  'memory.aliasExists': 'Alias v {files}',
  ...
  'memory.name': 'Název',
  'memory.nameHint': 'Vytvoří ~/.claude-nazev a alias claude-nazev.',
...
const pl: Record<MessageKey, string> = {
  ...
  'memory.description': 'Profile Claude znalezione w folderach .claude-* w katalogu domowym.',
  'memory.add': 'Dodaj własną pamięć',
  'memory.loading': 'Ładowanie własnych pamięci…',
  'memory.empty': 'Nie znaleziono własnych pamięci Claude.',
  ...
  'memory.name': 'Nazwa',
  'memory.nameHint': 'Tworzy ~/.claude-nazwa i alias claude-nazwa.',
...
const hu: Record<MessageKey, string> = {
  ...
  'memory.description': 'A saját mappa .claude-* könyvtáraiból felismert Claude profilok.',
  'memory.add': 'Egyéni memória hozzáadása',
  'memory.loading': 'Egyéni memóriák betöltése…',
  'memory.empty': 'Nem található egyéni Claude memória.',
  ...
  'memory.name': 'Név',
  'memory.nameHint': 'Létrehozza a ~/.claude-nev mappát és a claude-nev aliast.',
