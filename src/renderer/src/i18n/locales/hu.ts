...
export const hu: Record<MessageKey, string> = {
  ...
  'contentSearch.placeholder': 'Szöveg keresése fájlokban…',
  'contentSearch.noResults': 'Nincs egyező tartalom',
  'contentSearch.truncated': 'Csak az első tartalmi találatok láthatók',
  ...
  'keyboard.searchFileContents': 'Szöveg keresése a projektfájlokban',
  ...
  'footer.loading': 'Használat betöltése…',
  'footer.unavailable': 'A használat nem érhető el',
  'footer.notSignedIn': 'Nem található elérhető bejelentkezés ebben a profilban',
  'footer.expired': 'Jelentkezzen be újra ebbe a profilba',
  'footer.rateLimited': 'Túl sok kérés — újrapróbálkozás később',
  'footer.noData': 'Nincsenek jelentett előfizetési korlátok',
  'footer.remaining': 'Hátralévő % megjelenítése',
  'footer.compact': 'Tömör részletek',
  'footer.show': 'Megjelenítés a láblécben:',
  'footer.updated': 'Ellenőrizve',
  'footer.sharedLimit': 'Az azonos fiókba bejelentkezett profilok közös korlátokat használnak. A korlátok nem adódnak össze.',
  'footer.manage': 'Custom memory presetek kezelése',
  ...
  'remote.hint':
    'Használjon meglévő SSH aliast vagy user@host címet. A terminál presetek a szerveren, a megadott útvonalon futnak.',
  'remote.host': 'SSH host',
  'remote.hostPlaceholder': 'pl. prod vagy user@example.com',
  'remote.path': 'Remote útvonal',
  'remote.pathPlaceholder': '/home/user/project',
  'remote.name': 'Megjelenített név',
  'remote.namePlaceholder': 'Opcionális',
  'remote.test': 'Teszt',
  ...
  'titlebar.initGit': 'Git inicializálása',
  'titlebar.gitUnavailable': 'A Git nem érhető el',
  'titlebar.initGitTitle': 'Git repó inicializálása ebben a mappában',
  'terminal.statusWorking': 'Terminálkimenet fogadása…',
  'terminal.statusFinished': 'A terminál figyelmet igényel',
  ...
  'preview.unsavedConfirm': 'Elveted a fájl nem mentett módosításait?',
  'preview.discard': 'Elvetés',
  'preview.changedOnDiskTitle': 'A fájl megváltozott a lemezen',
  'preview.changedOnDiskConfirm':
    'Ezt a fájlt a betöltése után a szerkesztőn kívül módosították. Felülírod ezeket a változásokat?',
  'preview.overwrite': 'Felülírás',
  'launcher.deletePresetConfirm': 'Törlöd a(z) „{name}” elrendezést?',
  'changes.stageAllCommit': 'Mindet hozzáadás és commit',
  'changes.commitHint': 'Írj commit-üzenetet a gomb aktiválásához.',
  'history.loadFailed': 'Az előzményeket nem sikerült betölteni.',
  'history.justNow': '<1 perc',
  'history.loadMore': '{n} commit látható — továbbiak betöltése',
  'files.loadFailed': 'A fájlokat nem sikerült betölteni.',
  'files.clearSearch': 'Keresés törlése',
  'files.refresh': 'Fájlok frissítése',
  'search.noResults': 'Nincs találat',
  'tasks.errWorktreeMissing': 'A worktree létrehozása nem sikerült.',
  'tasks.failedToast': 'A feladat sikertelen: {prompt}',
  ...
  'footer.tickets': "Visszaállítási jegyek",
  'footer.applyTicket': "Egy jegy felhasználása",
  'footer.applying': "Alkalmazás…",
  'footer.ticketsUnknown': "A jegyek elérhetősége nem tölthető be.",
  'footer.noTickets': "Nincs elérhető jegy.",
  'footer.ticketExpires': "Lejárat",
  'footer.ticketNoExpiry': "Nincs megadott lejárat",
  'footer.ticketDetailsUnknown': "Nem minden jegy lejárati adata érhető el.",
  'footer.resetConfirm': "Felhasználod a Codex visszaállítási jegyet?",
  'footer.resetWarning': "Egy elérhető jegyet használsz fel a Codex-fiók korlátainak visszaállításához. Az azonos fiókhoz tartozó profilok közös korlátokat használnak. A jegyet a szolgáltató választja ki. Folytatod?",
  'footer.resetDone': "Codex-visszaállítás feldolgozva. Használat frissítése…",
  'footer.reset_nothingToReset': "Nincs visszaállítható korlát.",
  'footer.reset_noCredit': "Nincs elérhető jegy.",
  'footer.reset_accountChanged': "A bejelentkezett fiók megváltozott. Frissíts és erősítsd meg újra.",
  'footer.reset_unavailable': "A visszaállítás eredménye nem ellenőrizhető. Próbáld újra ugyanazt a kérést biztonságosan.",
  'footer.reset_busy': "Másik visszaállítás függőben van. Próbáld újra az eredeti profilban.",
}
