...
export const pl: Record<MessageKey, string> = {
  ...
  'notify.settingDesc': 'Pokaż powiadomienie systemowe, gdy agent zakończy pracę, a aplikacja jest w tle.',
  'notify.finishedTitle': '{label} zakończył',
  'notify.finishedBody': 'Workspace {workspace} jest gotowy.',
