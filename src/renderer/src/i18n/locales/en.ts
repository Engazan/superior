...
export const en = {
  ...
  'review.newLine': "new line {line}",
  'review.title': "Review comments",
  'review.count': "Comments ({count})",
  'review.send': "Send to agent",
  'review.snapshot': "Comments retain the original diff context, even after files change.",
  'review.storageFailed': "Could not save comments to disk. Keep the app open to retain them.",
  'review.edit': "Edit comment",
  'review.remove': "Remove",
  'review.hint': "Click + beside a diff line to leave a review comment.",
  'review.sendHint': "Sends all comments as one prompt and presses Enter. Choose an agent ready for input. Comments remain available for re-review.",
  'review.target': "Agent in this workspace",
  'review.select': "Select an agent…",
  'review.noAgents': "Start an agent in this workspace to send comments.",
  'review.failed': "Could not send the review. Comments were kept. Check the terminal before retrying.",
  ...
  'contentSearch.placeholder': 'Search text in files…',
  'contentSearch.noResults': 'No matching content',
  'contentSearch.truncated': 'Showing the first content matches only',
  ...
  'keyboard.searchFileContents': 'Search text in project files',
  ...
  'footer.close': 'Close',
  'footer.loading': 'Loading usage…',
  'footer.unavailable': 'Usage unavailable',
  'footer.notSignedIn': 'No readable sign-in found in this profile',
  'footer.expired': 'Sign in again in this profile',
  'footer.rateLimited': 'Too many requests — retrying later',
  'footer.noData': 'No subscription limits reported',
  'footer.remaining': 'Show remaining %',
  'footer.compact': 'Compact details',
  'footer.show': 'Show in footer:',
  'footer.updated': 'Checked',
  'footer.sharedLimit': 'Profiles signed into the same account share its limits. Limits are not added together.',
  'footer.manage': 'Manage custom memory presets',
  'usage.resets': 'resets',
  ...
  'terminal.statusWorking': 'Receiving terminal output…',
  'terminal.statusFinished': 'Terminal needs attention',
  ...
  'footer.tickets': "Reset tickets",
  'footer.applyTicket': "Use one ticket",
  'footer.applying': "Applying…",
  'footer.ticketsUnknown': "Ticket availability could not be loaded.",
  'footer.noTickets': "No available tickets.",
  'footer.ticketExpires': "Expires",
  'footer.ticketNoExpiry': "No expiry provided",
  'footer.ticketDetailsUnknown': "Expiry details are not available for all tickets.",
  'footer.resetConfirm': "Apply a Codex reset ticket?",
  'footer.resetWarning': "This consumes one available ticket to reset this account’s Codex limits. Profiles using the same account share these limits. The provider selects the ticket. Continue?",
  'footer.resetDone': "Codex reset processed. Refreshing usage…",
  'footer.reset_nothingToReset': "There are no limits to reset.",
  'footer.reset_noCredit': "No ticket is available.",
  'footer.reset_accountChanged': "The signed-in account changed. Refresh and confirm again.",
  'footer.reset_unavailable': "Reset result could not be verified. Retry to check the same request safely.",
  'footer.reset_busy': "Another reset is pending. Retry the original profile.",
}
