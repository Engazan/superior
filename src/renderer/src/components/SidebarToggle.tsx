...
export function SidebarToggle({ onClick, expanded }: Props): React.JSX.Element {
  const { t } = useI18n()
  ...
  return (
    <button
      ...
      className="group app-no-drag grid h-full w-8 place-items-center rounded-sm p-0 text-fgdim transition hover:bg-hover hover:text-fg focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent"
